...
<head>
    ...
    <link rel="stylesheet" href="assets/css/categorie2.css">
...
<body>
      ...
      <img src="./assets/img/images_the_district/bg2.jpeg" width="100%">
        ...
        <div class="cat1">
            <div class='carte1'>
                <div class='info'>
                  <a href="./"><h1 class='titre'>Nos Sandwich</h1></a>
                  <a href="./"><p class='description'>The District vous propose une large gamme de sushi, plateau individuel ou à partager ! </p></a>
                </div>
              </div>    
        </div>
        <div class="cat2">
            ...
            <div class='carte2'>
                <div class='info'>
                  <a href="./"><h1 class='titre'>Catégorie Veggie</h1> </a>
        ...
        <div class="cat3">
            <div class='carte3'>
                <div class='info'>
                  <a href="./"><h1 class='titre'>Nos Apéritif</h1></a>
        ...
        <div class="cat4">
            <div class='carte4'>
                <div class='info'>
                  <a href="./"><h1 class='titre'>Nos Boissons</h1></a>
        ...
        <div class="cat5">
            <div class='carte5'>
                <div class='info'>
                  <a href="./"><h1 class='titre'>Nos Fromage</h1></a>
        ...
        <div class="cat6">
            <div class='carte6'>
                   <div class='info'>
                  <a href="./"><h1 class='titre'>Nos Dessert</h1></a>
